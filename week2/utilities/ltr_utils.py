...
def create_rescore_ltr_query(user_query, query_obj, click_prior_query, ltr_model_name, ltr_store_name,
    ...
    ## NB ############### see Relevance engineering: https://tinyurl.com/2c6kbjs2
    query_obj["rescore"] = {
        ...
        "query": {
            ...
            # active_features added if present
        },
    }
...
def create_feature_log_query(query, doc_ids, click_prior_query, featureset_name, ltr_store_name, size=200, terms_field="_id"):
    # print("IMPLEMENT ME: create_feature_log_query") see Relevance engineering: tinyurl.com/49xkyfsf
    ## NB ###############
    query_obj = {
        'size': size,
        'query': {
