...
~/fastText-0.9.2/fasttext supervised -input /workspace/datasets/product_data/categories/categories.train -output /workspace/datasets/product_data/categories/model_categories 1 -lr 1.0 -epoch 50 -wordNgrams 2 -maxn 0
